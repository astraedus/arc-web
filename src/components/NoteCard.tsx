...
export default function NoteCard({
  ...
  return (
    <article
      className="group relative rounded-2xl border border-card-border bg-card p-6 transition-all hover:border-amber/30 hover:shadow-sm hover:bg-amber/[0.02]"
    >
      <Link
      ...
      <div className="pointer-events-none relative z-10">
        ...
        <p className="mt-3 whitespace-pre-wrap text-sm leading-relaxed text-foreground">
          <WikilinkText
            text={preview(note.content || "(empty note)")}
